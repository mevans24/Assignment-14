...
public class App extends Application {
    ...
    public boolean isWon(char token) {
        //Og: i < 3;
        for (int i = 0; i < 5; i++)
            //Og: if (cell[i][0].getToken() == token && cell[i][1].getToken() == token && cell[i][2].getToken() == token) {
        ...
        //Og: j < 3;
        for (int j = 0; j < 3; j++)
            //Og:if (cell[0][j].getToken() == token && cell[1][j].getToken() == token && cell[2][j].getToken() == token) {
        ...
        //Og: if (cell[0][0].getToken() == token && cell[1][1].getToken() == token && cell[2][2].getToken() == token) {
        ...
        //Og: if (cell[0][2].getToken() == token && cell[1][1].getToken() == token && cell[2][0].getToken() == token) {
    ...
    //private void setToken(char whoseTurn2) {
    //}
